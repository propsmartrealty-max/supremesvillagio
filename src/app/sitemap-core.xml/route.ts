...
export async function GET() {
  ...
  const corePages = [
    ...
    { url: '/supreme-villagio/vision', priority: '0.85', changefreq: 'monthly' },
    { url: '/supreme-villagio/architecture', priority: '0.85', changefreq: 'monthly' },
    { url: '/supreme-villagio/residences', priority: '0.85', changefreq: 'monthly' },
  ...
  ${corePages
    ...
    <url>
      ...
      <image:image>
        ...
        <image:title>Supreme Villagio Somatane Luxury Real Estate</image:title>
      </image:image>
